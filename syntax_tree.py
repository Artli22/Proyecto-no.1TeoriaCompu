class Node:
    ...
    hoja: izquierdo y derecho quedan en None. Los operadores '*', '+' y
    '?' son unarios y solo usan izquierdo. Los operadores '|' y '&'
    (concatenacion) son binarios y usan ambos hijos.
    """
